...
?><br>
<div class="politica">
    <label class="politica_label" for="">Términos y Condiciones de Uso</label><br><br>
    <label for="">INFORMACIÓN RELEVANTE</label><br>
    <p>Es requisito necesario para la adquisición de los servicios que se ofrecen en este sitio, que lea
    ...
    de alguno de nuestros servicios. Best Reference México no asume la responsabilidad en
    ...
    <p>Best Reference México a través de su sitio web concede una licencia específica por un lapso
    de tiempo definido para que los usuarios utilicen los servicios con el fin de lograr la
    acreditación de acuerdo a los Términos y Condiciones que se describen en este documento.</p><br>
    

    <label for="">USO NO AUTORIZADO</label><br>
    ...
    reventa de ningún tipo.</p><br>
    

    <label for="">PROPIEDAD</label><br> 
    ...
    de utilizar nuestros servicios.</p><br>

    <label for="">REEMBOLSO Y GARANTÍA</label><br>

    <p>Una vez concluido el servicio solicitado, no realizamos reembolsos después de que se envíen
    ...
    usado correctamente.</p><br>

    <label for="">PRIVACIDAD</label><br>

    <p>Best Reference México garantiza que la información personal que usted envía cuenta con la
    seguridad necesaria. Puede revisar más a detalle en nuestra POLÍTICA DE PRIVACIDAD
    Best Reference México reserva los derechos de cambiar o de modificar estos términos sin
    previo aviso. </p>
</div>
<br>
<?php
